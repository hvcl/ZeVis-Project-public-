...
"}"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/resource/images/icon_window_minimize.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/resource/images/icon_window_restore.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/resource/images/icon_window_maximize.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/resource/images/icon_window_close.png"), QSize(), QIcon::Normal, QIcon::Off);
